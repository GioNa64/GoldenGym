...
public class Usuario {
    ...
    public Usuario(int id, int idRol, int idGenero, String nombre, String apellido, String login, String password, LocalDate fechaRegistro, byte estatus, int top_aux, String confirmPassword_aux, Rol rol, Genero genero) {
        this.id = id;
        this.idRol = idRol;
